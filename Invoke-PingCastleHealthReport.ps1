...
### EDIT THIS PARAMETERS ### IMMY PARAMETERS NOW HAS THIS
...
$CustomPingCastlePath = 'C:\Reports\PingCastle'
### END ###

New-Item -Path "C:\Reports\PingCastle\Reports" -ItemType Directory -Force -ErrorAction SilentlyContinue | Out-Null
...
$PingCastle = [pscustomobject]@{
    ...
    ProgramPath     = $CustomPingCastlePath
